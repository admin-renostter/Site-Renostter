...
SUPABASE_STORAGE_LIMIT_BYTES = config("SUPABASE_STORAGE_LIMIT_BYTES", default=0, cast=int)
RENDER_STORAGE_LIMIT_BYTES = config("RENDER_STORAGE_LIMIT_BYTES", default=0, cast=int)
STORAGE_CLEANUP_THRESHOLD_PERCENT = config("STORAGE_CLEANUP_THRESHOLD_PERCENT", default=95, cast=float)
